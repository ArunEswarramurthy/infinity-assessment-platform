...
const TestResult = () => {
  ...
  useEffect(() => {
    // Get result from localStorage (set when test is submitted)
    ...
    <StudentLayout>
      <div className="max-w-4xl mx-auto p-6 space-y-6">
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded">
                    <strong>Explanation:</strong> {question.explanation || `The correct answer is ${question.correctOptionLetter}) ${question.correctOption}`}
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="text-center">
          <Button onClick={() => navigate('/student/assessment')} className="mr-4">
